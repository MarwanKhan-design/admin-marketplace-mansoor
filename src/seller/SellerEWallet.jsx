...
export default function SellerEWallet({ client, sellerId, onBack }) {
  ...
  const submit = async (event) => {
    ...
    if (client && sellerId) {
      ...
      if (error) {
        console.log("E-WALLET SAVE ERROR:", error);
        return;
      }
    }
        ...
        <form onSubmit={submit}>
          ...
          <label>
            ...
            <input
              ...
              onChange={(event) => update("walletName", event.target.value)}
            />
          </label>
          <label>
            Wallet Email
            <input
              ...
              onChange={(event) => update("walletEmail", event.target.value)}
            />
          </label>
          <label>
            Wallet Number
            <input
              ...
              onChange={(event) => update("walletNumber", event.target.value)}
            />
          </label>
          <label>
            Trade Password
